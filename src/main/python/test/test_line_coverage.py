...
class TestLineCoverage(unittest.TestCase):
    def test_clean(self):
        ...
        line_coverage_with_context = {
            'C:\\Users\\user\\Documents\\test_me\\example.py': {1: [''], 2: [''], 5: [''], 8: [''], 6: [
            ...
            'C:\\Users\\user\\Documents\\test_me\\test\\__init__.py': {1: ['']},
            'C:\\Users\\user\\Documents\\test_me\\test\\test_example_e.py': {1: [''], 3: ['']
